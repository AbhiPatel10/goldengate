        ...
        <>
            <div className="m-auto px-4 container grid lg:grid-cols-6 md:grid-cols-3 grid-rows-2 lg:gap-4 md:gap-2 gap-2">
                <div className="lg:col-span-3">
                    <div className="h-full overflow-hidden FAQ-main-container border-gray-700 border py-4 lg:px-4 md:px-3 px-3 rounded-lg shadow-md">
                        ...
                        <p className="mt-4 text-gray-800 text-base text-justify"  data-aos='fade-up'>
                ...
                <div className="lg:col-span-3">
                    <div className="h-full overflow-hidden FAQ-main-container border-gray-900 border py-4 lg:px-4 md:px-3 px-3 rounded-lg shadow-md">
                        <div className="flex justify-between">
                            <div className="flex">
                        ...
                        <p className="mt-4 text-base text-justify text-gray-800" data-aos='fade-up'>
                ...
                <div className="lg:col-span-2 md:col-span-2 row-span-2">
                    <div className="h-full border-gray-900 FAQ-main-container border py-4 lg:px-4 md:px-3 px-3 rounded-lg shadow-md">
                        <div className="flex justify-between">
                            <div className="flex">
