        ...
        <>
            <section>
                <div className='w-full my-20 '>
                    <div class="h-full sm:px-10 Faq-card px-4 rounded-2xl max-w-5xl m-auto py-14">
                        <h1 class="leading-relaxed mb-6 sm:text-3xl md:text-4xl text-2xl text-gray-900 font-bold Faq-card-header">Q. When is a FAQ page appropriate?</h1>
