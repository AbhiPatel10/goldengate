    ...
    return (
        <>
            <section >
                ...
                <SectionHeader title="Director form" />
            </section>
            <section >
                    ...
                    <form class="w-full m-auto">
                        <div class="w-full flex flex-wrap mb-6">
                            <div class="w-full px-3 ">
                                ...
                                <input class="appearance-none block w-full bg-gray-100 text-gray-900 border border-gray-500 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Enter your key" />
                            </div>
                        </div>
