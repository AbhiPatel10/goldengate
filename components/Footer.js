                    ...
                    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                ...
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800">Service</a>
                                </li>
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800">Contact</a>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 className="title-font font-medium text-gray-200 tracking-widest text-xl mb-3">Legel</h2>
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800">privacy</a>
                                </li>
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800">terms of service</a>
                                </li>
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800">disclaimer</a>
                                </li>
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800">banking partners</a>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li className="flex flex-col">
                                    ...
                                    <a className="text-gray-300 hover:text-gray-800">help@sliceit.com</a>
                                </li>
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none flex justify-evenly mt-7">
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800"><BsFacebook  className='text-xl' /> </a>
                                </li>
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800"><BsInstagram className='text-xl' /></a>
                                </li>
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800"><BsTwitter className='text-xl' /></a>
                                </li>
                                <li>
                                    <a className="text-gray-300 hover:text-gray-800"><BsLinkedin className='text-xl' /></a>
                                </li>
                            </nav>
                        </div>
                    </div>
